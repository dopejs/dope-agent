...
pub use events::{
    ...
    new_event_id, thread_continuity_preview_recorded_event,
    thread_continuity_turn_recorded_event,
};
pub use service::{
    OPENAI_COMPATIBLE_PROVIDER_NAME, available_overlays, compile_prompt_messages,
    continuity_source_kind, handoff_reference_continuity_reason,
    inject_continuity_messages, inject_handoff_source_reference_messages,
    preview_item_for_handoff_source_reference, profile_context_messages,
    resolve_selected_skills, response_continuity_source_event_key,
    selected_skill_contracts, selected_skill_ids_from_skills,
    terminal_dispatch_event,
};
