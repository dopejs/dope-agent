...
/// Apply `DOPE_*` environment variable overrides onto `cfg`
...
pub(crate) fn apply_env_overrides(cfg: &mut Config) {
    ...
    cfg.environment = resolve_environment(&getenv("DOPE_ENV", ""), &cfg.version);
    cfg.bind_addr = getenv("DOPE_BIND_ADDR", &cfg.bind_addr);
    cfg.data_dir = getenv("DOPE_DATA_DIR", &cfg.data_dir);
    cfg.log_level = getenv("DOPE_LOG_LEVEL", &cfg.log_level);
    cfg.version = getenv("DOPE_VERSION", &cfg.version);

    cfg.llm.default_provider = getenv("DOPE_LLM_DEFAULT_PROVIDER", &cfg.llm.default_provider);
    cfg.llm.default_model = getenv("DOPE_LLM_DEFAULT_MODEL", &cfg.llm.default_model);
    cfg.llm.default_timeout_ms = getenv_int("DOPE_LLM_DEFAULT_TIMEOUT_MS", cfg.llm.default_timeout_ms);
    cfg.llm.default_max_retries = getenv_int("DOPE_LLM_DEFAULT_MAX_RETRIES", cfg.llm.default_max_retries);
    ...
    cfg.llm.claude.cli_path = getenv("DOPE_LLM_CLAUDE_CLI_PATH", &cfg.llm.claude.cli_path);
    cfg.llm.claude.default_model = getenv("DOPE_LLM_CLAUDE_MODEL", &cfg.llm.claude.default_model);
    cfg.llm.claude.work_dir = getenv("DOPE_LLM_CLAUDE_WORKDIR", &cfg.llm.claude.work_dir);
    cfg.llm.codex.cli_path = getenv("DOPE_LLM_CODEX_CLI_PATH", &cfg.llm.codex.cli_path);
    cfg.llm.codex.default_model = getenv("DOPE_LLM_CODEX_MODEL", &cfg.llm.codex.default_model);
    cfg.llm.codex.work_dir = getenv("DOPE_LLM_CODEX_WORKDIR", &cfg.llm.codex.work_dir);

    cfg.connectors.discord.enabled =
        getenv_bool("DOPE_CONNECTORS_DISCORD_ENABLED", cfg.connectors.discord.enabled);
    ...
    cfg.connectors.telegram.enabled =
        getenv_bool("DOPE_CONNECTORS_TELEGRAM_ENABLED", cfg.connectors.telegram.enabled);
    ...
    cfg.connectors.slack.enabled =
        getenv_bool("DOPE_CONNECTORS_SLACK_ENABLED", cfg.connectors.slack.enabled);
    ...
    cfg.connectors.matrix.enabled =
        getenv_bool("DOPE_CONNECTORS_MATRIX_ENABLED", cfg.connectors.matrix.enabled);
