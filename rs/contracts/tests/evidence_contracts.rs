...
fn test_evidence_bundle_schemas_accept_canonical_fixtures() {
    ...
    let fixtures: &[Fixture] = &[
        (r##"schemas/api/generate-evidence-bundle.request.schema.json"##, r##"{"actor":"support@dope","scope":{"kind":"routine","ref":"routine_1"}}"##),
        (r##"schemas/api/evidence-bundle-resource.schema.json"##, r##"{"bundleId":"evidence_bundle_1","tenantId":"ten_a","actor":"support@dope","scope":{"kind":"routine","ref":"routine_1"},"sections":[{"kind":"routine","resourceRefs":["routine_1"],"summary":{"state":"failed","accessToken":"[redacted]"},"links":["/v1/routines/routine_1"]}],"redactionStatus":"redacted","createdAt":"2026-06-30T10:00:00Z","retentionExpiresAt":"2026-07-14T10:00:00Z"}"##),
    ];
