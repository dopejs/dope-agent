...
| 5 store | audit(558), dope-store core+domains(28.6k, split), migrationfixture(1513), tenancy(2626), checkpoints(107), delivery(1817), managerdoc(66), sandbox(3419) | in progress (migrations v1-55 + CRUD done for runs/steps/tool_calls/checkpoints/sessions/capabilities/llm/providers/policy/identity/computeruse/integrations/calendar/mail/manager-documents/sandbox-executions; reminders/mcp/delivery/schedule/consumer-policy/secret-scope CRUD + sandbox/delivery managers + audit + tenancy + migrationfixture pending; connectors/orchestration/events/evaluation CRUD blocked on their type crates) |
