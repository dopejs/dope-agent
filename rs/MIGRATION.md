...
| 4 runtime-services | computeruse(1239), artifacts(158), orchestration(869), evaluation(3396), events(2185) | done (2/5; orchestration/evaluation/events blocked on wave 5-6 store/sandbox/mcp/skills) |
| 5 store | audit(558), dope-store core+domains(28.6k, split), migrationfixture(1513), tenancy(2626), checkpoints(107), delivery(1817), managerdoc(66), sandbox(3419) | in progress (migrations v1-55 + all unblocked store CRUD done: runs/steps/tool_calls/checkpoints/sessions/capabilities/llm/providers/policy/identity/computeruse/integrations/calendar/mail/reminders/mcp/delivery/schedule/consumer-policy/secret-scope/manager-documents/sandbox-executions; connectors/orchestration/events/evaluation CRUD blocked on their type crates; sandbox/delivery managers + audit + tenancy + migrationfixture pending) |
