...
| 3 integration-base | connectors-root(1543), integrations(1674), calendar(1665), mail(2468), opsreadiness(1939), policy(259), feishulark(1457), runtime(1120) | in progress (integrations, policy, calendar, mail, runtime done; feishulark fault taxonomy+token done; opsreadiness types done, opsreadiness logic + feishulark HTTP client+providers pending) |
