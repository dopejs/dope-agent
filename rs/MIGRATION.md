...
| 8 surface | api(26.3k, split by route family), app(2401), daemon binary wiring, contract-test parity | done (16 route families; app DI wiring + dope-cli binary serving end-to-end; contract-test suite 68 tests/570 schemas; + parity closure: evaluation/livevalidation/setupwizard/computeruse/billing Store impls, delivery connector adapter, activation/execprofile/evidence seams, mcp concrete transports) |
