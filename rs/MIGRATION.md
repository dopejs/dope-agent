...
| 3 integration-base | connectors-root(1543), integrations(1674), calendar(1665), mail(2468), opsreadiness(1939), policy(259), feishulark(1457), runtime(1120) | done (7/8; connectors-root deferred — depends on wave 4-7 chat/checkpoints/store/im/events) |
| 4 runtime-services | computeruse(1239), artifacts(158), orchestration(869), evaluation(3396), events(2185) | done (4/5; orchestration crate + evaluation types + events types/Bus ported; orchestration/evaluation/events MANAGERS remain — see wave 6/8) |
| 5 store | audit(558), dope-store core+domains(28.6k, split), migrationfixture(1513), tenancy(2626), checkpoints(107), delivery(1817), managerdoc(66), sandbox(3419) | in progress (migrations v1-55 + CRUD done for runs/steps/tool_calls/checkpoints/sessions/capabilities/llm/providers/policy/identity/computeruse/integrations/calendar/mail/reminders/mcp/delivery/schedule/consumer-policy/secret-scope/manager-documents/sandbox-executions/events/connectors/evaluation; workflow CRUD in flight; sandbox/delivery managers + tenancy + migrationfixture + audit domains pending) |
