...
| 5 store | audit(558), dope-store core+domains(28.6k, split), migrationfixture(1513), tenancy(2626), checkpoints(107), delivery(1817), managerdoc(66), sandbox(3419) | done (CRUD all domains: migrations v1-55 + runs/steps/tool_calls/checkpoints/sessions/capabilities/llm/providers/policy/identity/computeruse/integrations/calendar/mail/reminders/mcp/delivery/schedule/consumer-policy/secret-scope/manager-documents/sandbox-executions/events/connectors/evaluation/workflow; remaining: sandbox/delivery managers + tenancy + migrationfixture + audit domains) |
