...
- Do not implement WhatsApp, DopeAgent-hosted Matrix homeserver provisioning, encrypted rooms, E2EE key/session management, voice/calls, media-rich workflows, bridge automation, or memory-based personalization in this phase.
