...
var queryPlanCases = []queryPlanCase{
	...
	{
		name:          "evaluation_discovery_policies_list_by_tenant_enabled",
		sql:           `SELECT policy_id FROM evaluation_discovery_policies WHERE tenant_id = ? AND enabled = ? ORDER BY updated_at DESC, policy_id DESC LIMIT 50`,
		args:          []any{"ten_owner", 1},
		expectedIndex: "idx_eval_discovery_policies_tenant_enabled",
	},
	{
		name:          "evaluation_discovery_runs_list_by_tenant_status",
		sql:           `SELECT discovery_run_id FROM evaluation_discovery_runs WHERE tenant_id = ? AND status = ? ORDER BY updated_at DESC, discovery_run_id DESC LIMIT 50`,
		args:          []any{"ten_owner", "completed"},
		expectedIndex: "idx_eval_discovery_runs_tenant_status",
	},
	{
		name:          "evaluation_discovered_candidates_list_by_tenant_ready",
		sql:           `SELECT discovered_candidate_id FROM evaluation_discovered_candidates WHERE tenant_id = ? AND readiness_status = ? ORDER BY updated_at DESC, discovered_candidate_id DESC LIMIT 50`,
		args:          []any{"ten_owner", "ready"},
		expectedIndex: "idx_eval_discovered_candidates_tenant_ready",
	},
	{
		name:          "evaluation_product_fixtures_list_by_tenant_review",
		sql:           `SELECT fixture_id FROM evaluation_product_fixtures WHERE tenant_id = ? AND review_state = ? ORDER BY updated_at DESC, fixture_id DESC LIMIT 50`,
		args:          []any{"ten_owner", "approved"},
		expectedIndex: "idx_eval_product_fixtures_tenant_review",
	},
	{
		name:          "evaluation_campaigns_list_by_tenant_status",
		sql:           `SELECT campaign_id FROM evaluation_campaigns WHERE tenant_id = ? AND status = ? ORDER BY created_at DESC, campaign_id DESC LIMIT 50`,
		args:          []any{"ten_owner", "completed"},
		expectedIndex: "idx_eval_campaigns_tenant_status",
	},
	{
		name:          "evaluation_dashboard_projections_list_by_tenant_generated",
		sql:           `SELECT projection_id FROM evaluation_dashboard_projections WHERE tenant_id = ? ORDER BY generated_at DESC, projection_id DESC LIMIT 50`,
		args:          []any{"ten_owner"},
		expectedIndex: "idx_eval_dashboard_projections_tenant_generated",
	},
	{
		name:          "evaluation_tool_call_inspections_list_by_tenant_campaign",
		sql:           `SELECT inspection_id FROM evaluation_tool_call_inspections WHERE tenant_id = ? AND campaign_id = ? ORDER BY updated_at DESC, inspection_id DESC LIMIT 50`,
		args:          []any{"ten_owner", "campaign_a"},
		expectedIndex: "idx_eval_tool_call_inspections_tenant_campaign",
	},
	{
