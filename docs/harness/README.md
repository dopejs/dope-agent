...
This module defines the execution substrate above the daemon core: skills, memory, sandbox, MCP, orchestration, and self-improvement.
...
- the document defines skill, sandbox, MCP, orchestration, context, memory, or dreaming behavior
- the document changes harness ordering or control-plane responsibilities
- the document defines managed artifacts such as agent-managed skills
